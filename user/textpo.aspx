<%@ Page Language="C#" MasterPageFile="~/user/useMasterPage.master" AutoEventWireup="true" CodeFile="textpo.aspx.cs" Inherits="user_newtext" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContentPlaceHolder" Runat="Server">
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT word_id, image, text, writer, date, po, username FROM TabWord WHERE (text &lt;&gt; N'0') AND (po &lt; 20) AND (username &lt;&gt; @username) AND (po &gt; 0) ORDER BY word_id DESC">
            <SelectParameters>
...
font-family:Tahoma;font-size:xx-small;">
                <a href='<%# Eval("word_id","showwordpo.aspx?WID={0}") %>'><%# Eval("writer")%><asp:Label 
...
&nbsp;</a><br />
            ...
            <div style="font-family:Tahoma; font-size:10pt;text-align:right; direction:rtl;">
                ...
                <table align="right" class="DataList" dir="rtl" lang="fa" width="100%">
                    <tr>
                        <td>
                            <a href='<%# Eval("word_id","showwordpo.aspx?WID={0}") %>'>
                            <img alt="" height="75" src='../<%# Eval("image") %>' width="75" /></a>
                         
                        </td>
                        <td align="justify" width="75%">
                            متن پیشنهاد شده :<br />
                            <b style="font-family: 'B Titr'; font-size: large; text-decoration: underline">
                            <asp:Label ID="Label6" runat="server" Text='<%# Eval("text") %>'></asp:Label>
                            </b>
                            <br />
                            متیاز کسب شده تا کنون :<br />
                            <asp:Label ID="NewsDateLabel2" runat="server" Text='<%# Eval("po") %>' />
                            <br />
                            &nbsp; پیشنهاد دهنده :<br />
                            <b style="font-family: 'B Titr'; font-size: large; text-decoration: underline">
